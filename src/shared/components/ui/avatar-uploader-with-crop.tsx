...
export interface AvatarUploaderWithCropProps {
  // Core props
  value?: File | null;
...
export const AvatarUploaderWithCrop: React.FC<AvatarUploaderWithCropProps> = ({
  // Core props
  value = null,
  onChange = () => {},
    ...
    <>
      <div className={cn("flex flex-col items-center space-y-2", className)}>
        ...
        <div className="relative group">
          <div
            className={cn(
              "relative cursor-pointer transition-all duration-300 overflow-hidden flex items-center justify-center group",
      ...
      {enableCrop && tempImageSrc && (
        <ImageCropDialog
          ...
          cropShape={variant === "circle" ? "round" : "rect"}
        />
      )}
    </>
  );
